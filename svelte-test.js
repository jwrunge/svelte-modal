var modal = (function () {
    ...
    /* src\SvelteTest.svelte generated by Svelte v3.38.3 */
    ...
    // (11:4) <Modal heading="Svelte modal works!" on:close={()=>{ modalOpen = false }}>
    function create_default_slot(ctx) {
    	...
    	return {
    		c() {
    			p = element("p");
    			p.textContent = "Here is some generic placeholder text.";
    			t1 = space();
    			div = element("div");
    			button = element("button");
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*modalOpen*/ ctx[0] && create_if_block$1(ctx);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [modalOpen, click_handler, click_handler_1, close_handler];
    }

    class SvelteTest extends SvelteComponent {
    	constructor(options) {
    		super();
